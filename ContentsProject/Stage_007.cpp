...
void AStage_007::BeginPlay()
{
	...
	LoadBrick("Stage7", PlayerLifeActor);
}

void AStage_007::Tick(float _DeltaTime)
{
	Super::Tick(_DeltaTime);

	if (true == UEngineInput::GetInst().IsDown('N'))
	{
		UEngineAPICore::GetCore()->OpenLevel("Stage_006");
	}
...
void AStage_007::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
