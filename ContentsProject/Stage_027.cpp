...
void AStage_027::BeginPlay()
{
	...
	LoadBrick("Stage27", PlayerLifeActor);
}

void AStage_027::Tick(float _DeltaTime)
{
	...
	{
		UEngineAPICore::GetCore()->OpenLevel("Stage_028");
	}
}

void AStage_027::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
