...
void AStage_022::BeginPlay()
{
	...
	LoadBrick("Stage22", PlayerLifeActor);
}

void AStage_022::Tick(float _DeltaTime)
{
	...
	{
		UEngineAPICore::GetCore()->OpenLevel("Stage_023");
	}
}

void AStage_022::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
