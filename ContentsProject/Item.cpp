...
AItem::AItem()
{
	...
	//SpriteRenderer2->SetComponentScale({ 32, 14 });
	...
	SpriteRenderer1->CreateAnimation("Lasers", "Item1.png", 8,  15, 0.1f);
	SpriteRenderer1->CreateAnimation("Enlarge", "Item1.png", 16, 23, 0.1f);
	SpriteRenderer1->CreateAnimation("Catch", "Item1.png", 24, 31, 0.1f);
	SpriteRenderer1->CreateAnimation("Slow", "Item1.png", 32, 39, 0.1f);
	SpriteRenderer1->CreateAnimation("Break", "Item1.png", 40, 47, 0.1f);
	SpriteRenderer1->CreateAnimation("Disruption", "Item1.png", 48, 55, 0.1f);
