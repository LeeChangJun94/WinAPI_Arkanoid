...
void AStage_032::BeginPlay()
{
	...
	LoadBrick("Stage32", PlayerLifeActor);
}

void AStage_032::Tick(float _DeltaTime)
{
...
void AStage_032::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
