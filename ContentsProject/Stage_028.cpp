...
void AStage_028::BeginPlay()
{
	...
	LoadBrick("Stage28", PlayerLifeActor);
}

void AStage_028::Tick(float _DeltaTime)
{
...
void AStage_028::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
