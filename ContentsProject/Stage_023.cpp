...
void AStage_023::BeginPlay()
{
	...
	LoadBrick("Stage23", PlayerLifeActor);
}

void AStage_023::Tick(float _DeltaTime)
{
	Super::Tick(_DeltaTime);

	if (true == UEngineInput::GetInst().IsDown('N'))
	{
		UEngineAPICore::GetCore()->OpenLevel("Stage_022");
	}
...
void AStage_023::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
