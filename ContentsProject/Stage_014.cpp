...
void AStage_014::BeginPlay()
{
	...
	LoadBrick("Stage14", PlayerLifeActor);
}

void AStage_014::Tick(float _DeltaTime)
{
...
void AStage_014::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
