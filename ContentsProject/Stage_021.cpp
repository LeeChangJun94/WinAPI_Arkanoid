...
void AStage_021::BeginPlay()
{
	...
	LoadBrick("Stage21", PlayerLifeActor);
}

void AStage_021::Tick(float _DeltaTime)
{
...
void AStage_021::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
