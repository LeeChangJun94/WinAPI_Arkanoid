...
void AStage_005::BeginPlay()
{
	...
	LoadBrick("Stage5", PlayerLifeActor);
}

void AStage_005::Tick(float _DeltaTime)
{
...
void AStage_005::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
