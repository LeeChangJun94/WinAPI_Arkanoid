...
void AStage_004::BeginPlay()
{
	...
	LoadBrick("Stage4", PlayerLifeActor);
}

void AStage_004::Tick(float _DeltaTime)
{
...
void AStage_004::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
