...
void AStage_018::BeginPlay()
{
	...
	LoadBrick("Stage18", PlayerLifeActor);
}

void AStage_018::Tick(float _DeltaTime)
{
...
void AStage_018::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
