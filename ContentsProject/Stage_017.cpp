...
void AStage_017::BeginPlay()
{
	...
	LoadBrick("Stage17", PlayerLifeActor);
}

void AStage_017::Tick(float _DeltaTime)
{
...
void AStage_017::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
