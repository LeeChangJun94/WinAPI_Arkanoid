...
void AStage_010::BeginPlay()
{
	...
	LoadBrick("Stage10", PlayerLifeActor);
}

void AStage_010::Tick(float _DeltaTime)
{
...
void AStage_010::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
