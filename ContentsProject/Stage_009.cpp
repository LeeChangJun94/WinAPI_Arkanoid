...
void AStage_009::BeginPlay()
{
	...
	LoadBrick("Stage9", PlayerLifeActor);
}

void AStage_009::Tick(float _DeltaTime)
{
	Super::Tick(_DeltaTime);

	if (true == UEngineInput::GetInst().IsDown('N'))
	{
		UEngineAPICore::GetCore()->OpenLevel("Stage_008");
	}
...
void AStage_009::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
