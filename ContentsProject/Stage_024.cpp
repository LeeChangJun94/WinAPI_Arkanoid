...
void AStage_024::BeginPlay()
{
	...
	LoadBrick("Stage24", PlayerLifeActor);
}

void AStage_024::Tick(float _DeltaTime)
{
...
void AStage_024::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
