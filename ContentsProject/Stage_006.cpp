...
void AStage_006::BeginPlay()
{
	...
	LoadBrick("Stage6", PlayerLifeActor);
}

void AStage_006::Tick(float _DeltaTime)
{
	Super::Tick(_DeltaTime);

	if (true == UEngineInput::GetInst().IsDown('N'))
	{
		UEngineAPICore::GetCore()->OpenLevel("Stage_005");
	}
...
void AStage_006::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
