...
void AStage_029::BeginPlay()
{
	...
	LoadBrick("Stage29", PlayerLifeActor);
}

void AStage_029::Tick(float _DeltaTime)
{
...
void AStage_029::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
