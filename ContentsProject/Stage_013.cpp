...
void AStage_013::BeginPlay()
{
	...
	LoadBrick("Stage13", PlayerLifeActor);
}

void AStage_013::Tick(float _DeltaTime)
{
...
void AStage_013::LoadBrick(std::string _Stage, APlayerLife* _PlayerLifeActor)
{
